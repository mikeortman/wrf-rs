program specified_boundary_tendencies_benchmark
  ...
  field_tend=1.2;west=0.;east=0.;south=0.;north=0.
  west_tend=.1;east_tend=.2;south_tend=.3;north_tend=.4
...
contains
  subroutine invoke
    call spec_bdytend(field_tend,west,east,south,north, &
      ...
      boundary_width,5,ids,ide,jds,jde,kds,kde,ims,ime,jms,jme,kms,kme, &
      ids,ide,jds,jde,kds,kde,ids,ide,jds,jde,kds,kde)
  end subroutine
end program specified_boundary_tendencies_benchmark
