...
| ARW dynamical core | In progress | sheet exact-bit cases plus slab boundary/halo oracle | Benchmark the limiter family, then select the next dependency-closed kernel |
